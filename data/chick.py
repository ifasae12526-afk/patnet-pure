r""" Chick few-shot segmentation dataset (CD-FSS) """
import os
import random
...
class DatasetChick(Dataset):
    ...
    Identical to SAM2CDFSS DatasetChick for apple-to-apple comparison.
    Supports episode multiplication and joint augmentation for small datasets.
    """
